...
class SellerAuthViewModel extends ChangeNotifier {
  ...
  Future<bool> login(String email, String password) async {
    ...
    final result = await _userRepo.login(email, password, 'seller');
    ...
    if (result != null) {
      ...
      _error = 'Email atau password salah. Pastikan terdaftar sebagai Seller.';
      notifyListeners();
      return false;
    }
  }
  ...
  Future<bool> register(String nama, String email, String phone, String password) async {
    ...
    _loading = false;
    if (id > 0) {
      _successMessage = 'Akun Seller berhasil dibuat! Silakan login.';
      notifyListeners();
      return true;
    } else {
